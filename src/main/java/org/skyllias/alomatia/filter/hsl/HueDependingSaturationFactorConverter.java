...
public class HueDependingSaturationFactorConverter implements HslConverter
{
...
//==============================================================================
  ...
  /** Applies an {@link AntiBoostingFactor} to the result of the function with
   *  the original saturation, but only if saturation is not 0 (because in this
   *  case the hue is undefined). */
