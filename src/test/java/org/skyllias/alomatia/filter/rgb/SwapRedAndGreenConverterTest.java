...
public class SwapRedAndGreenConverterTest
{
  ...
  {
    assertEquals(new Color(0, 255, 0), converter.convertColor(new Color(255, 0, 0)));
  }

  @Test
  public void shouldTurnGreenToRed()
  {
    assertEquals(new Color(255, 0, 0), converter.convertColor(new Color(0, 255, 0)));
  }

  @Test
  public void shouldKeepBlueChannel()
  {
    assertEquals(new Color(54, 209, 100), converter.convertColor(new Color(209, 54, 100)));
  }
}
