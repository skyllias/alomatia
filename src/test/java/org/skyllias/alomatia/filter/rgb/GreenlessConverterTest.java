...
public class GreenlessConverterTest
{
  ...
  {
    assertEquals(new Color(255, 0, 255), converter.convertColor(new Color(255, 255, 255)));
  }
  ...
  {
    assertEquals(new Color(132, 0, 201), converter.convertColor(new Color(132, 80, 201)));
  }
